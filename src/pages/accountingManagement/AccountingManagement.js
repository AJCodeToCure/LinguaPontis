...
const AcountingManagement = () => {
  ...
  return (
    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="flex-1 pl-20 flex flex-col overflow-hidden">
        {/* <Navbar /> */}
          ...
          <div className="border rounded-lg">
            <div className="mb-1 p-4 flex flex-col sm:flex-row sm:justify-between sm:items-center">
              <h1 className="text-2xl font-bold font-[Nunito] mb-4 sm:mb-0">
                Beneficiary Accounting Details
              </h1>
              ...
              <table className="min-w-full bg-white">
                <thead className='bg-[#EAECF0]'>
                  <tr className="">
                    ...
                    <th className="py-2 px-3 text-left text-[12px] font-[Montserrat] text-[var(--blueColor)]">Beneficiary</th>
                    <th className="py-2 px-3 text-left text-[12px] font-[Montserrat] text-[var(--blueColor)]">Idioma</th>
                    <th className="py-2 px-3 text-left text-[12px] font-[Montserrat] text-[var(--blueColor)]">Team Members</th>
                    <th className="py-2 px-3 text-left text-[12px] font-[Montserrat] text-[var(--blueColor)]">Assigned Task</th>
                    <th className="py-2 px-3 text-left text-[12px] font-[Montserrat] text-[var(--blueColor)]">Received Date</th>
                    <th className="py-2 px-3 text-left text-[12px] font-[Montserrat] text-[var(--blueColor)]">Total Hours Available</th>
                    <th className="py-2 px-3 text-left text-[12px] font-[Montserrat] text-[var(--blueColor)]">Hours Consumed</th>
                    <th className="py-2 px-3 text-left text-[12px] font-[Montserrat] text-[var(--blueColor)]">Remaining Hours</th>
...
export default AcountingManagement;