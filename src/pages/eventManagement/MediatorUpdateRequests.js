...
function MediatorUpdateRequests() {
    ...
    const fetchRequests = async () => {
        try {
            const response = await axios.get(`${API}/api/mediator_accept/`, {
                headers: {
                    'Authorization': `Bearer ${token}`,
                },
            });
    ...
    const handleRequest = async (requestId, action) => {
        ...
        try {
            ...
            const response = await axios.put(`${API}/api/mediator_accept/${requestId}/`, payload, {
                headers: {
                    'Authorization': `Bearer ${token}`,
                },
            });
...
export default MediatorUpdateRequests;
